...
print("A) Number of parcel we can take with us with the greedy algorithm:", greedy_results["length"] + " parcels")
print("B) Minimal total cost when taking 83 parcels to space (accounted for different FTW) : $" + greedy_results["cost"])
